...
6. Use on open-source, object-oriented statistical programming language (in this case R) to conduct all such analyses
...
I will be mindful of the many impacts the unfolding events related to COVID-19 may be having on you. There may be situations beyond the control of individual students that lead to excessive absences such as becoming ill, caring for others, managing home schooling, etc. 
